  ...
  return (
    <main className="flex-1">
      ...
      <section className="relative">
        <div className="relative bg-[url('https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80')] bg-cover bg-center">
        <div className="absolute inset-0 bg-slate-50/40 dark:bg-black/50"></div>
          {/* 
          <Image
            src="/placeholder.svg"
